...
import datetime
import bpy
from venturial.utils.classy import mesh_builder, foam_runner, geometry_extractor, vtk_importer, case_setup
from venturial.utils.classy import foam_path_utils
from venturial.utils.classy import auto_update as _auto_update
...
class CLASSY_OT_export_terrain_stl(bpy.types.Operator):
    """Export selected mesh as terrain STL into the active case"""
