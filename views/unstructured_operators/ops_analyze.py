...
from venturial.utils.unstructured import utils_system

class CFMESH_OT_RunCheckMesh(bpy.types.Operator):
    bl_idname = "cfmesh.run_checkmesh"
...
class CFMESH_OT_ShowResiduals(bpy.types.Operator):
    bl_idname = "cfmesh.show_residuals"
