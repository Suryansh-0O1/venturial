...
class CFMESH_OT_GenerateCFMesh(bpy.types.Operator):
    bl_idname = "cfmesh.generate_cfmesh"
    ...
    def execute(self, context):
        ...
        from venturial.models.unstructured_properties import _compute_cell_estimate
        est, explosion_msg = _compute_cell_estimate(props)
        props.est_cell_count = min(est, 2147483647)
        ...
        try:
            ...
            utils_mesh.combine_ascii_stls(temp_stl_dir, stl_path)
            ...
            full_cmd = utils_mesh.build_mesher_command()
