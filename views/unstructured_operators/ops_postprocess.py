...
class CFMESH_OT_LaunchParaView(bpy.types.Operator):
    bl_idname = "cfmesh.launch_paraview"
...
class CFMESH_OT_LoadResult(bpy.types.Operator):
    bl_idname = "cfmesh.load_result"
...
class CFMESH_OT_OpenExportDir(bpy.types.Operator):
    bl_idname = "cfmesh.open_export_dir"
